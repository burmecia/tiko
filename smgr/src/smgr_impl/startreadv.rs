...
pub extern "C-unwind" fn tiko_startreadv(
    ...
    unsafe {
        ...
        if (coalesced.len() as i32) > max_iovcnt {
        ...
        //    During initdb the perform function handles I/O directly via ops;
        //    under the postmaster, IO workers submit to the worker pipeline.
