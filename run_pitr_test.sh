...
TIKO_DB_ID="34"
TIKO_PROJECT_ID="56"
TIKO_ROOT_PATH=/Users/bolu/supabase/tmp/tiko
...
$PG_BIN_DIR/psql -d postgres -c "create temp table tt(a int);insert into tt values(123);checkpoint;"
sleep 2

$PG_BIN_DIR/pg_ctl -D tt -l log.log stop

# Run the Tiko PITR CLI to list available PITR points
cargo run -p cli --bin tiko_pitr -- list